...
For the purposes of online compiling services, the toolchain is built Dockerized -- and the ARM one just built smoothly without any extra effort. [Here](https://github.com/FPGAOL-CE/osstoolchain-docker-things) you can find a bunch of ready-to-use Dockerized toolchains. 
